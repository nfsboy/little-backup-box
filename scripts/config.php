			...
			<details>
				...
				<h3><?php echo L::config_backup_header; ?></h3>
					...
					<select name="BACKUP_MODE" id="BACKUP_MODE">
						...
						<option value="Del DCIM" <?php echo $config["conf_BACKUP_DEFAULT_SOURCE"] . " " . $config["conf_BACKUP_DEFAULT_TARGET"]=="storage internal"?" selected":""; ?>><?php echo L::config_backup_storage_internal; ?></option>
